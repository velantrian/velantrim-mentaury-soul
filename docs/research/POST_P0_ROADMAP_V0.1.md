...
> The header and body below are a 2026-08-15 checkpoint and are **not** current engineering truth.
...
> - EPR-v0.1 implemented bounded (PR #148); Phase 4 Owner GO consumed;
> - V1 offline epistemic E2E verified (PR #150);
> - V1 Research/Core 1.0.0 final acceptance complete;
> - Issue #129 closed/superseded;
